...
<div class="intro-y box px-5 pt-5 mt-5">
    <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
        ...
        <div
            ...
            <!-- <div class="truncate sm:whitespace-normal flex items-center mt-3">
                ...
                Tug‘ilgan sanasi :{{ $userinfo->birthday }}
            </div> -->
            <div class="truncate sm:whitespace-normal flex items-center mt-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                Telefon raqami : {{ "+".$userinfo->phone ?? +998991234567 }}
            </div>
            <div class="truncate sm:whitespace-normal flex items-center mt-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="nav-tabs flex flex-col sm:flex-row justify-center lg:justify-start">
        ...
        <a data-toggle="tab" data-target="#yakuniy_hisobot" href="javascript:;" class="py-4 sm:mr-8 flex items-center">
            <i data-feather="file-text"></i> Yakuniy hisobot 
        </a>
    </div>
</div>
@if (session('status'))
    ...
    <div class="tab-content__pane active" id="buyurtmachi_tashkiloti">
        @forelse ($organizationinfos as $organizationinfo)
                <div class="overflow-x-auto"
                    style="background-color: white;margin-top:30px;border-radius:8px;padding:30px 20px;" id="birinchibor{{$organizationinfo->order_number}}">
                    <table class="table">
                        <tbody>
                            <div
                                ...
                                <div style="text-align: end;">
                                    ...
                                    <form
                                        action="{{ route('organizationinfo.destroy', ['organizationinfo' => $organizationinfo->id]) }}"
                            ...
                            <tr>
                                ...
                                <td class="border border-2">{{ $organizationinfo->yuq_tashkilot }} </td>
                            </tr>
                            <tr class="bg-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="border border-2">{{ $organizationinfo->tashkilot }}</t>
                            </tr>
                            <tr class="bg-gray-200">
        ...
        <div class="overflow-x-auto"
            ...
            <table class="table">
                    ...
                    <div
                                ...
                                <div style="text-align: end;">
                                    <a href="{{ route('internshipinfo.create') }}" class="button w-24 bg-theme-1 text-white"
                                        style="margin-right:20px;">
                                        Qo'shish
                                    </a>
                                    ...
                                    <form
                                        action="{{ route('internshipinfo.destroy', ['internshipinfo' => $internshipinfo->id]) }}"
                                        style="display: inline;" method="post"
                                        onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                                        <button type="submit" class="button w-24 bg-theme-6 text-white">
                                            @csrf
                            ...
                            <tr>
                                <!-- <th class="border border-2" style="width: 40px;">#</th> -->
                                <th class="border border-2" style="width: 100%;text-align: center;font-weight: bold; font-size:16px;" colspan="2"> Ma’lumotlar</th>
                                <!-- <th class="border border-2" style="width: 50%;">Ma’lumot</th> -->
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">1</th> -->
                            ...
                            <tr >
                                ...
                                <td class="border border-2">{{ $internshipinfo->xorijiy_mamlakat }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr >
                                ...
                                <td class="border border-2">{{ $internshipinfo->stajirovka_yon }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                ...
                <div class="overflow-x-auto"
                    ...
                    <table class="table">
                        <tbody>
                            <div
                                style="display: flex;justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 20px;">
                                <div style="font-size:18px;font-weight: 400;"> Moliyalashtirish to‘g‘risida ma’lumotlar
                                    {{$internshipfile->order_number}}
                                </div>
                                <div style="text-align: end;">
                                    ...
                                    <a href="{{ route('internshipfile.edit', ['internshipfile' => $internshipfile->id]) }}"
                                        class="button w-24 bg-theme-1 text-white" style="margin-right:20px;">
                                        Tahrirlash
                                    </a>
                                    <form action="{{ route('internshipfile.destroy', ['internshipfile' => $internshipfile->id]) }}"
                                        style="display: inline;" method="post"
                                        onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                                        <button type="submit" class="button w-24 bg-theme-6 text-white">
                                            @csrf
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{  \Carbon\Carbon::parse($internshipfile->tracking_decision_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{ \Carbon\Carbon::parse($internshipfile->special_expert_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{  \Carbon\Carbon::parse($internshipfile->agency_order_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{  \Carbon\Carbon::parse($internshipfile->contract_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr>
                                <!-- <th class="border border-2">6</th> -->
                                <td class="border border-2">{{  \Carbon\Carbon::parse($internshipfile->date)->format('d-m-Y') }}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{ \Carbon\Carbon::parse($internshipfile->financial_letter_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                            ...
                            <tr>
                                ...
                                <td class="border border-2">
                                    {{  \Carbon\Carbon::parse($internshipfile->scientific_letter_date)->format('d-m-Y') }}</td>
                            </tr>
                            <tr class="bg-gray-200">
                                <!-- <th class="border border-2">5</th> -->
                ...
                <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5">
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $internshipfile->proposal_and_program_file) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
                            <a href="" class="block font-medium mt-4 text-center truncate">Buyurtmachi tomonidan Agentlikka
                                yuboriladigan kafolat xati, xarajatlar asosnomasi, taklifnoma va dastur</a>
                            <div class="text-gray-600 text-xs text-center">2.2 MB</div>
                            <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                                <a class="dropdown-toggle w-5 h-5 block" href="javascript:;"> <i data-feather="more-vertical"
                                        class="w-5 h-5 text-gray-500"></i> </a>
                    ...
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $internshipfile->quadripartite_agreement_file) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
                            <a href="" class="block font-medium mt-4 text-center truncate">Ilmiy stajirovka bo‘yicha 4 tomonlama
                                shartnoma</a>
                            <div class="text-gray-600 text-xs text-center">2.2 MB</div>
                            <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                                <a class="dropdown-toggle w-5 h-5 block" href="javascript:;"> <i data-feather="more-vertical"
                ...
                <div class="overflow-x-auto"
                    ...
                    <div style="display: flex;justify-content: space-between;  ">
                        ...
                        <div style="text-align: end;">
                            ...
                            <a href="{{ route('finalreport.edit', ['finalreport' => $finalreport->id]) }}"
                                class="button w-24 bg-theme-1 text-white" style="margin-right:20px;">
                                Tahrirlash
                            </a>
                            <form action="{{ route('finalreport.destroy', ['finalreport' => $finalreport->id]) }}"
                                style="display: inline;" method="post"
                                onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
                                <button type="submit" class="button w-24 bg-theme-6 text-white">
                                    @csrf
                ...
                <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5">
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $finalreport->follow_up_letter) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
                            <a href="" class="block font-medium mt-4 text-center truncate">Kuzatuv xati</a>
                    ...
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $finalreport->council_decision) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
                            <a href="" class="block font-medium mt-4 text-center truncate">Ilmiy kengash qarori</a>
                    ...
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $finalreport->scientific_report) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
                    ...
                    <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            ...
                            <a href="{{ asset('storage/' . $finalreport->financial_reporting) }}" target="_blank"
                                class="w-3/5 file__icon file__icon--file mx-auto">
                                <div class="file__icon__file-name">PDF</div>
                            </a>
