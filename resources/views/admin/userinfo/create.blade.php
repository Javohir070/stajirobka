...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
    ...
    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
        <form id="science-paper-create-form" method="POST" action="{{ route("userinfo.store") }}" class="validate-form"
            ...
            <div class="grid grid-cols-12 gap-2">
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="firs_name" value="{{ old('firs_name') }}" class="input w-full border mt-2" required="">
                    @error('firs_name')
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name') }}" class="input w-full border mt-2" required="">
                    @error('last_name')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="middle_name" value="{{ old('middle_name') }}" class="input w-full border mt-2" required="">
                    @error('middle_name')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="date"  name="birthday" value="{{ old('birthday') }}"   class=" input w-full border mt-2" required="">
                    @error('birthday')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="jshshri" value="{{ old('jshshri') }}" class="input w-full border mt-2" required="">
                    @error('jshshri')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6">
                    ...
                    <select name="gender" value="{{ old('gender') }}" id="science-sub-category" class="input border w-full mt-2" required="">
                ...
                <div class="w-full col-span-6">
                    ...
                    <select name="academic_degree" value="{{ old('academic_degree') }}" id="science-sub-category" class="input border w-full mt-2" required="">
                ...
                <div class="w-full col-span-6">
                    ...
                    <select name="certificate" value="{{ old('certificate') }}" id="science-sub-category" class="input border w-full mt-2" >
                        ...
                        <option value="Milliy sertipikat">Milliy sertipikat</option>
