            ...
            <tbody>
                ...
                <div
                    ...
                    <div style="font-size:18px;font-weight: 400;">
                        {{ $xodimlar->tashkilot->name_qisqachasi . " xodim " . $xodimlar->fish }} xaqida ma’lumot
                    </div>
                    @can('xodim delete edit')
                        <div style="text-align: end;">
                            <a href="{{ route('xodimlar.edit', ['xodimlar' => $xodimlar->id])}}"
                ...
                <tr>
                    <!-- <th class="border border-2" style="width: 40px;">#</th> -->
                    <th class="border border-2"
                        style="width: 100%;text-align: center;font-weight: bold; font-size:16px;" colspan="2">Mehnat
                        faoliyat</th>
                    <!-- <th class="border border-2" style="width: 50%;">Ma’lumot</th> -->
                </tr>
                ...
                <tr>
                    <!-- <th class="border border-2" style="width: 40px;">#</th> -->
                    <th class="border border-2"
                        style="width: 100%;text-align: center;font-weight: bold; font-size:16px;" colspan="2">Ma’lumoti
                        / Ixtisosligi</th>
                    <!-- <th class="border border-2" style="width: 50%;">Ma’lumot</th> -->
                </tr>
                <tr class="bg-gray-200">
