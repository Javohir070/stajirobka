        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <a class="navbar-brand" href="/" >
                    <img src="/admin/dist/images/logo.png" style="width: 24px;" alt="Cynic brand logo" > <span style="font-size:24px;">Science ID</span>
                </a>
                    ...
                    <!-- End of .social-icons -->
                    <p class="copywrite-txt">© 2022 <a href="http://www.axilthemes.com">Axilthemes</a>. All Rights
                        Reserved.</p>
                </div>
            </div>
